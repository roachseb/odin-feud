    ...
    function create_if_block_4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$6, 303, 4, 6582);
    			attr_dev(div1, "class", "message svelte-5ub8ge");
    			add_location(div1, file$6, 302, 2, 6516);
    		},
    		m: function mount(target, anchor, remount) {
    			insert_dev(target, div1, anchor);
    			append_dev(div1, div0);
    ...
    function create_if_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$6, 310, 8, 6776);
    			attr_dev(div1, "class", "logo logo-border-animation svelte-5ub8ge");
    			add_location(div1, file$6, 309, 6, 6726);
    			add_location(span, file$6, 313, 8, 6875);
    			add_location(button, file$6, 312, 6, 6836);
    			attr_dev(div2, "class", "column-center svelte-5ub8ge");
    			add_location(div2, file$6, 308, 4, 6691);
    		},
    		m: function mount(target, anchor, remount) {
    			insert_dev(target, div2, anchor);
    			append_dev(div2, div1);
    ...
    function create_else_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$6, 327, 6, 7294);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = text("Next Round");
    			span0 = element("span");
    			add_location(span0, file$6, 324, 53, 7235);
    			add_location(span1, file$6, 324, 37, 7219);
    			add_location(button, file$6, 324, 8, 7190);
    			attr_dev(div, "class", "row-center svelte-5ub8ge");
    			add_location(div, file$6, 323, 6, 7156);
    		},
    		m: function mount(target, anchor, remount) {
    			insert_dev(target, div, anchor);
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file$6, 320, 35, 7084);
    			add_location(button, file$6, 320, 8, 7057);
    			attr_dev(div, "class", "row-center svelte-5ub8ge");
    			add_location(div, file$6, 319, 6, 7023);
    		},
    		m: function mount(target, anchor, remount) {
    			insert_dev(target, div, anchor);
    			append_dev(div, button);
    ...
    function create_if_block_3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = text("Pass?");
    			span0 = element("span");
    			add_location(span0, file$6, 346, 43, 7805);
    			add_location(span1, file$6, 346, 32, 7794);
    			add_location(button, file$6, 346, 8, 7770);
    		},
    		m: function mount(target, anchor, remount) {
    			insert_dev(target, button, anchor);
    			append_dev(button, span1);
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$6, 306, 0, 6642);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
